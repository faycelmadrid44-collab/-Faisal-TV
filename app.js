...
async function initializeApp() {
    ...
    try {
        ...
        currentUser = { host: HOST, user: USER, pass: PASS };
        ...
        splashScreen.innerHTML = `
            <div class="splash-content">
                ...
                <h1 class="splash-title">Faisal TV</h1>
                <p class="splash-error">❌ خطأ الاتصال</p>
                <p style="color:#D4AF37;margin-top:20px;font-size:12px;">${error.message}</p>
